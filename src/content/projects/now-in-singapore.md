...
images: [/img/projects/nowinsg-desktop.png::Now In Singapore desktop interface showing curated event listings., /img/projects/nowinsg-mobile.png::Now In Singapore mobile interface for browsing events on the go.]
---

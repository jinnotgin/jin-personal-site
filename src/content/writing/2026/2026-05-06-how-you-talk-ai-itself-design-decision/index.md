...
---
![Illustrated cover showing structured and iterative ways of working with AI](./cover.jpg)
...
![Illustration contrasting frontend taste with backend contractual precision](./inline-1.jpg "Frontend quality lives in judgment you can only access once something exists to react to")
...
![Illustration showing spec-driven and iterative development as two ends of a spectrum](./inline-2.jpg "Spec-driven prompting is waterfall compressed into minutes; iterative prompting is agile compressed into a single session")
...
![Illustration of Matt Pocock's spec-first grill-me workflow](./inline-3.jpg "Matt Pocock's /grill-me skill interrogates every branch of a plan before a line of code is written")
...
![Illustration of Simon Willison's test-first iterative loop approach](./inline-4.jpg "Simon Willison anchors iterative loops with tests and a hard rule: never commit code you can't explain to someone else")
...
![Screenshot of Skills Framework Explorer showing hybrid spec-then-iterate approach](./inline-5.jpg "Skills Framework Explorer: data model specced upfront, search interface discovered through iteration")

...
![Claude Design tweaks panel with red accent settings](/img/writing/code-first-design-ai-dlc-claude-design/image-20260518-030223.png "For example, switching the color accent to red, and hiding certain widgets")
...
![Claude Design prompt fragment tooltip](/img/writing/code-first-design-ai-dlc-claude-design/image-20260518-030412.png)
...
![Claude Design usage limit message](/img/writing/code-first-design-ai-dlc-claude-design/image-20260518-031059.png "I can feel your pain 😥")
...
![Open Design output with GLM 4.6](/img/writing/code-first-design-ai-dlc-claude-design/image-20260518-031431.png "Open Design + GLM 4.6")

![Open Design output with GPT 5.5](/img/writing/code-first-design-ai-dlc-claude-design/image-20260518-031524.png "Open Design + GPT 5.5")
...
![Personal site before redesign](/img/writing/code-first-design-ai-dlc-claude-design/image-20260518-033136.png "Before")
...
![Claude Design prompt files list](/img/writing/code-first-design-ai-dlc-claude-design/image-20260518-033352.png "Oh my gosh the number of files")
...
![Two feedback loops diagram by Tuhin Nair](/img/writing/code-first-design-ai-dlc-claude-design/image-20260518-081259.png "The two feedback loops as illustrated by Tuhin Nair")

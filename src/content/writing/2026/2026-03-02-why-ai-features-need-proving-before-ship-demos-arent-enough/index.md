...
![Illustration of polished AI output that hides numerical errors inside confident prose](./inline-1.jpg "The report read confidently. The numbers were wrong. Polish is not proof.")
...
![Illustration showing a POC as a timestamp rather than a permanent verdict](./inline-2.jpg "A failed POC is a timestamp, not a verdict. The same idea tested today with better models might pass.")
...
![Illustration of Pete, an internal RAG tool that passed the POC but failed the POV](./inline-3.jpg "Pete answered HR questions accurately. People just didn't have HR questions often enough.")
...
![Illustration showing Pete succeeding when applied to daily project documentation](./inline-4.jpg "The same technology, routed to project documentation, became something developers relied on daily")

...
tags: [research, survey-analysis, workflow, tooling, applied-ai, signals]
status: published
...
![Asking Gemini for a survey report structure](./image-20260109-061347.png "By the way, LLMs are quite tolerant to typos, as you can see from my ri-di-cu-lous spelling mistakes in the prompt 🤣")
...
![Claude generating the draft report](./image-20260109-063047.png "Tables, executive summary, recommendations. Formatted cleanly, read professionally. The numbers weren't right.")
...
![ChatGPT running Python scripts to verify numbers](./gpt5.1_thinking_step1.png "11 minutes of Python scripts, one after another, to count every row programmatically")
...
![ChatGPT rewriting the report with corrected figures](./GPT_5.1_step2.png "12 minutes and 28 seconds later: Claude's structure, ChatGPT's verified numbers")

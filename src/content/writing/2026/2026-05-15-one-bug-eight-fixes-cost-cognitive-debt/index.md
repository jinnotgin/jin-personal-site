...
tags: [engineering, promptpal, cognitive-debt, applied-ai]
status: published
...
![PromptPal showing two red error messages after a failed Excel upload](./promptpal-upload-error.png "Uh oh. Red means bad.")
...
![Upload progress screen showing sheet-by-sheet conversion status](./upload-processing-feedback.png "Showing more in-progress feedback to the user")
...
![JSON output of an Excel file bloated by invisible formatting across empty columns](./excel-empty-columns-expanded-output.png "How PromptPal sees an Excel file with invisible formatting applied across thousands of empty columns")
...
![All the Codex chat sessions used to push the eight fixes](./codex-fix-sessions.png "All the chats within Codex to push the eight fixes, roughly two hours of work total")

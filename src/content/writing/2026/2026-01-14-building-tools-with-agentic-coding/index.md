...
![Codex IDE tool identifying relevant files](./codex-ide-files.png "Codex maps the codebase and surfaces which files the feature will need to touch")
...
![Claude Opus providing an implementation plan](./claude-opus-plan.png "One expensive question, one detailed answer. Opus produces the plan before implementation begins.")
...
![Iterating on code with Roo Code and Gemini Flash](./roo-code-iterations.png "14 exchanges with Flash, each one cheap enough to iterate freely without rationing questions")

...
year: 2020
status: archived
intent: A blockchain-based BMW membership app that connected customer rewards to real service and purchase journeys.
stack: [Mobile app, blockchain rewards, loyalty programme, platform delivery]
links: [App (Google Play)::https://play.google.com/store/apps/details?id=com.bmwjoy, Enjin blockchain reference::https://enjin.io/ecosystem/bmw-vantage-app/]
images: [./bmw-vantage.jpg::BMW Vantage membership app interface for earning and using rewards.]
---
